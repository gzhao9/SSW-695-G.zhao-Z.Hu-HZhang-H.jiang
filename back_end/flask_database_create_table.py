...
class foodInfo(db.Model):
    ...
    protein = db.Column(db.Float(6,2), default = 0)
    fat = db.Column(db.Float(6,2), default = 0)
    carbohydrate = db.Column(db.Float(6,2), default = 0)
    energy = db.Column(db.Float(6,2), default = 0)
    sugar = db.Column(db.Float(6,2), default = 0)
    va = db.Column(db.Float(6,2), default = 0)
    vc = db.Column(db.Float(6,2), default = 0)
    def __repr__(self):
